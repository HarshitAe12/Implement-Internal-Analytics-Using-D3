...
const D3NetworkGraph = ({
    ...
    useEffect(() => {
        ...
        const simulation = d3
            ...
            .force(
                "charge",
                d3.forceManyBody().strength(-90) // ⬅ less repulsion
            )
            .force(
                "collision",
                d3.forceCollide().radius(d => 14 + d.connections) // ⬅ compact
            )
            .force("center", d3.forceCenter(w / 2, h / 2))
            .force("x", d3.forceX(w / 2).strength(0.05)) // ⬅ pulls inward
